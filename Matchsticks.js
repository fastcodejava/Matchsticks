...
//	};
    ...
    function solveEqn(input, sticksToMove, numMatchsticks, sticksFloating) {
      // console.log(input);
      let sticksMoved = 0; sticksFloating = 0, results = [];
      let done = false;
    ...
    function processInput(runningInput, sticksFloating, results) {
        ...
        if (verifyResults(runInput)) buildResponse(runInput, sticksFloating, results);
    ...
    function processOutput1(runningInput, sticksFloating, results) {
          ...
          if (sticksFloating === 0) {
              ...
              // console.log(runInput);
              if (val === reslt)
                  buildResponse(runInput, reslt, results);
              // console.log(val);
              ...
              for (let idx1 = 0; idx1 < runInput.length; idx1++) {
                  for (let idx2 = idx1 + 1; idx2 < runInput.length; idx2++) {
                      ...
                      // console.log(val, reslt);
                      if (val === reslt) {
                          buildResponse(runInput, results);
                      }
                      // console.log(val, reslt,);
